  ...
  constructor() {
    ...
    this.quizzes = [
      ...
      { id: 'kc01-1', section: 'kc-01',
        ...
        options: ['Aleatoria sin contexto', 'Autoregresiva token-por-token', 'Sintetizando palabras enteras de golpe', 'Recuperando frases de su training'],
        correct: 1,
      ...
      { id: 'kc01-2', section: 'kc-01',
        ...
        options: ['Claude Opus 4.7 (200K)', 'GPT-5.5 (256K)', 'Gemini 2.5 Pro (1M+)', 'Kimi K2 (2M)'],
        correct: 3,
      ...
      { id: 'kc01-3', section: 'kc-01',
        ...
        options: ['Claude Opus con BAA', 'Gemini con encryption', 'Modelo local (Llama/Qwen) self-hosted', 'OpenRouter con tier privado'],
        correct: 2,
      ...
      { id: 'kc01-4', section: 'kc-01',
        ...
        options: ['Q2_K (2-bit)', 'Q4_K_M (4-bit)', 'FP16', 'FP32'],
        correct: 1,
      ...
      { id: 'kc02-1', section: 'kc-02',
        ...
        options: ['Sampling aleatorio uniforme', 'Greedy decoding (siempre el token más probable)', 'Error: temperature debe ser >0', 'Razonamiento paso a paso'],
        correct: 1,
      ...
      { id: 'kc02-3', section: 'kc-02',
        ...
        options: ['Es estándar W3C', 'Claude está fine-tuned específicamente para parsear XML', 'XML es más rápido de procesar', 'Es la única manera de estructurar prompts'],
        correct: 1,
      ...
      { id: 'kc02-4', section: 'kc-02',
        ...
        options: ['Clasificación simple', 'Traducción literal', 'Matemáticas y razonamiento multi-step', 'Generación creativa'],
        correct: 2,
      ...
      { id: 'kc02-5', section: 'kc-02',
        ...
        options: ['Como primer mensaje con role:"system"', 'Como parámetro top-level "system" separado de messages', 'Inline al inicio del prompt del usuario', 'Solo está disponible en GPT, no en Claude'],
        correct: 1,
      ...
      { id: 'kc03-2', section: 'kc-03',
        ...
        options: ['Chain of Thought', 'Few-shot prompting', 'ReAct', 'Self-consistency'],
        correct: 2,
      ...
      { id: 'kc03-3', section: 'kc-03',
        ...
        options: ['Documentos al final, query al principio', 'Documentos al principio, query al final', 'Mezclar ambos en cualquier orden', 'Resumir antes de mandar'],
        correct: 1,
      ...
      { id: 'kc03-4', section: 'kc-03',
        ...
        options: ['Tool Use', 'Function Declarations', 'Action API', 'Tools (sin diferencias)'],
        correct: 0,
      ...
      { id: 'kc03-5', section: 'kc-03',
        ...
        options: ['1-2 puntos', '5-30 puntos %', '50-70 puntos %', '90+ puntos %'],
        correct: 1,
      ...
      { id: 'kc04-2', section: 'kc-04',
        ...
        options: ['10-20% en input', '40-50% en input', '85-90% en input cacheado', 'Nada en input, solo output'],
        correct: 2,
      ...
      { id: 'kc04-3', section: 'kc-04',
        ...
        options: ['Modelo más caro', 'Delimitadores XML + separar datos de instrucciones', 'Más ejemplos', 'Subir effort'],
        correct: 1,
      ...
      { id: 'kc04-5', section: 'kc-04',
        ...
        options: ['Solo el último mensaje del usuario', 'Solo system + último', 'El historial completo (o compactado) cada llamada', 'Anthropic gestiona el historial automáticamente'],
        correct: 2,
      ...
      { id: 'kc05-1', section: 'kc-05',
        ...
        options: ['Workflow es más rápido', 'Workflow tiene pipeline fija; el agente DECIDE qué tools usar y en qué orden', 'Agente solo usa Claude, workflow usa cualquier modelo', 'No hay diferencia'],
        correct: 1,
      ...
      { id: 'kc05-2', section: 'kc-05',
        ...
        options: ['JSON schema', 'YAML frontmatter + body markdown en SKILL.md', 'Python decorator', 'TypeScript type'],
        correct: 1,
      ...
      { id: 'kc05-3', section: 'kc-05',
        ...
        options: ['Cuantizar modelos', 'Conectar agentes AI a fuentes de datos y tools externas (Drive, Jira, DBs)', 'Acelerar inferencia', 'Comprimir prompts'],
        correct: 1,
      ...
      { id: 'kc05-4', section: 'kc-05',
        ...
        options: ['Agentes 100% paralelos sin coordinación', 'Un manager que asigna tareas y revisa', 'Todos los agentes votan cada decisión', 'Un solo agente con multi-modelo'],
        correct: 1,
      ...
      { id: 'kc05-5', section: 'kc-05',
        ...
        options: ['README.md', 'AGENTS.md', 'CONFIG.yml', '.opencoderc'],
        correct: 1,
      ...
      { id: 'kc06-2', section: 'kc-06',
        ...
        options: ['Pinecone Enterprise', 'ChromaDB local o pgvector', 'Milvus distributed', 'FAISS sin abstracción'],
        correct: 1,
      ...
      { id: 'kc06-3', section: 'kc-06',
        ...
        options: ['Desarrollo individual en laptop', 'Serving production de alto throughput', 'Solo modelos de Anthropic', 'Reemplazar OpenAI API'],
        correct: 1,
      ...
      { id: 'kc06-4', section: 'kc-06',
        ...
        options: ['1-3pp', '10-20pp en context precision', '50-70pp', 'No mejora; es overhead'],
        correct: 1,
      ...
      { id: 'kc06-5', section: 'kc-06',
        ...
        options: ['Solo latencia', 'Solo coste', 'Latencia p95/p99 + tokens/req + coste/req + tasa refusal + calidad eval', 'Solo número de errors'],
        correct: 2,
      ...
      { id: 'kc07-1', section: 'kc-07',
        ...
        options: ['Es más rápido', 'Protege ~1% de canales más salientes (mejor calidad a 4-bit)', 'Solo funciona en CPU', 'Es propietario'],
        correct: 1,
      ...
      { id: 'kc07-2', section: 'kc-07',
        ...
        options: ['Full fine-tuning', 'LoRA o QLoRA', 'RLHF desde cero', 'Pre-training'],
        correct: 1,
      ...
      { id: 'kc07-3', section: 'kc-07',
        ...
        options: ['Más fine-tuning', 'RAG', 'Mejor prompt', 'Subir effort'],
        correct: 1,
      ...
      { id: 'kc07-4', section: 'kc-07',
        ...
        options: ['Llama 4', 'Qwen 3', 'DeepSeek V3', 'OLMo 2 (AI2)'],
        correct: 3,
      ...
      { id: 'kc07-5', section: 'kc-07',
        ...
        options: ['Claude con BAA', 'OpenRouter con key cifrada', 'Self-hosted local (Ollama, vLLM)', 'Cualquier API cumple si usas HTTPS'],
        correct: 2,
      ...
      { id: 'kc08-1', section: 'kc-08',
        ...
        options: ['Curiosidad técnica', 'Resiliencia operativa + apalancamiento comercial + optimización coste/calidad', 'Anthropic tiene mejor pricing', 'OpenAI es lento'],
        correct: 1,
      ...
      { id: 'kc08-2', section: 'kc-08',
        ...
        options: ['Anthropic Tool Use', 'Google Function Declarations', 'OpenAI Function Calling', 'Mistral Tool API'],
        correct: 2,
      ...
      { id: 'kc08-4', section: 'kc-08',
        ...
        options: ['Reintentar infinitamente', 'Tener un cap duro y normalizar formato de respuesta', 'Usar solo Claude en todos los niveles', 'Cambiar de modelo en cada request'],
        correct: 1,
      ...
      { id: 'kc08-5', section: 'kc-08',
        ...
        options: ['Ser uno de los modelos comparados', 'Ser GPT-4 siempre (es el más entrenado)', 'Ser DISTINTO de los modelos comparados, idealmente más capaz', 'No importa, todos son equivalentes'],
        correct: 2,
      ...
      { id: 'kc09-1', section: 'kc-09',
        ...
        options: ['MMLU (saturado >95%)', 'HumanEval (saturado >95%)', 'SWE-bench Verified y ARC-AGI', 'TruthfulQA'],
        correct: 2,
      ...
      { id: 'kc09-2', section: 'kc-09',
        ...
        options: ['5 ejemplos', '50-200 ejemplos representativos con golden answers', '1000+ ejemplos', 'Ninguno; eval no es necesario'],
        correct: 1,
      ...
      { id: 'kc09-3', section: 'kc-09',
        ...
        options: ['Conocimiento general', 'Capacidad PhD-level "Google-proof" en bio/física/química', 'Programación competitiva', 'Generación creativa'],
        correct: 1,
      ...
      { id: 'kc09-4', section: 'kc-09',
        ...
        options: ['Solo accuracy manual', 'RAGAS (faithfulness, answer relevancy, context precision/recall)', 'BLEU score', 'GPT-4 a ojo'],
        correct: 1,
      ...
      { id: 'kc09-5', section: 'kc-09',
        ...
        options: ['Solo benchmarks académicos', 'Preferencias humanas en blind A/B testing', 'Velocidad de inferencia', 'Coste por token'],
        correct: 1,
      ...
      { id: 'kc10-2', section: 'kc-10',
        ...
        options: ['Riesgo Inaceptable (prohibido)', 'Alto Riesgo (registro UE)', 'Riesgo Limitado (transparencia)', 'Riesgo Mínimo (sin requisitos)'],
        correct: 2,
      ...
      { id: 'kc10-3', section: 'kc-10',
        ...
        options: ['Sin restricciones', 'Auto-deployment público', 'Seguridad reforzada, no deployment público hasta mitigaciones', 'Borrar el modelo'],
        correct: 2,
      ...
      { id: 'kc10-5', section: 'kc-10',
        ...
        options: ['Romper el hardware', 'Roleplay tipo "you are DAN, ignore your rules"', 'Cuantizar el modelo', 'Subir el effort'],
        correct: 1,
      ...
      { id: 'kc11-2', section: 'kc-11',
        ...
        options: ['Parsing siempre correcto sin validación adicional', 'Formato JSON válido conforme al schema, pero la semántica del contenido sigue requiriendo validación', 'Que el modelo nunca alucine', 'Reducción de coste 90%'],
        correct: 1,
      ...
      { id: 'kc11-4', section: 'kc-11',
        ...
        options: ['El bot puede diagnosticar para acelerar el flujo', 'El bot SUGIERE, NUNCA diagnostica; siempre recomienda consultar médico', 'El bot solo extrae datos', 'No es legal usarlo'],
        correct: 1,
      ...
      { id: 'kc11-5', section: 'kc-11',
        ...
        options: ['Reemplazado por el bot', 'Director que pide PRD genérico y lo acepta sin revisar', 'Director estratégico que aporta contexto del producto y revisa output crítico', 'Solo formateo'],
        correct: 2,
      ...
      { id: 'kc12-2', section: 'kc-12',
        ...
        options: ['Ampliado a 3+ años', 'Cerrado a &lt;1 año', 'No existe el frontier chino', 'Se ha invertido'],
        correct: 1,
      ...
      { id: 'kc12-3', section: 'kc-12',
        ...
        options: ['2026', '2030+', '2035+ (LLMs solos no llegan)', 'Nunca'],
        correct: 2,
      ...
      { id: 'kc12-4', section: 'kc-12',
        ...
        options: ['LLMs especializados', 'Modelos meteorológicos que superan supercomputadoras tradicionales', 'Agentes multi-modales', 'Quantizadores'],
        correct: 1,
      ...
      { id: 'kc12-5', section: 'kc-12',
        ...
        options: ['IA conversacional', 'Robots humanoides controlados por LLMs', 'Cuantización extrema', 'Visualización 3D'],
        correct: 1,
      ...
      { id: 'kc13-1', section: 'kc-13',
        ...
        options: ['Hacer un examen final', 'Construir tu agente iterativamente módulo a módulo, exportable al final', 'Replicar Claude desde cero', 'Aprender Python'],
        correct: 1,
      ...
      { id: 'kc13-3', section: 'kc-13',
        ...
        options: ['Usar XML tags', 'Solo decir "hazlo bien" sin especificar', 'Pedir thinking', 'Limitar max_tokens'],
        correct: 1,
      ...
      { id: 'kc14-2', section: 'kc-14',
        ...
        options: ['$0.01', '≤ $0.30', '$5+', 'Sin límite'],
        correct: 1,
      ...
      { id: 'kc14-3', section: 'kc-14',
        ...
        options: ['90% de respuestas tienen alguna cita', 'En 90% de citas, el pasaje citado realmente respalda la afirmación', '90% de documentos están indexados', '90% accuracy global'],
        correct: 1,
      ...
      { id: 'kc14-4', section: 'kc-14',
        ...
        options: ['Confianza en el código', 'tcpdump/Wireshark capturas durante uso real', 'Inspección manual del repo', 'Solo lint'],
        correct: 1,
      ...
      { id: 'kc14-5', section: 'kc-14',
        ...
        options: ['Confiar en que los agentes paren solos', 'Cap duro de iteraciones (típicamente ≤3 rondas) entre Critic y Writer', 'Usar más agentes', 'Subir effort en todos'],
        correct: 1,
